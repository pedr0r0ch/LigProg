...
//funcao que exibe o menu interativo e retorna o indice da opcao escolhida
...
//exibe uma mensagem de aviso em vermelho
...
//define cor no terminal (utilizado pela n curses)
void setCor(int n){
    if(has_colors())
        attron(COLOR_PAIR(n));
};
