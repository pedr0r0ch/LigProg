...
Edicao :: ~Edicao(){
    ...
    mensagemDeAviso("A imagem resultante da edicao sera salva como 'edicaoFinal.png'. Pressione enter para prosseguir");
    getch();
